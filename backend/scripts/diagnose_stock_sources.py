...
from app.services.stock_position_service import diagnose_stock_sources  # noqa: E402


def main() -> int:
    print("Diagnostico de fuentes de stock SAP - solo lectura")
    for source in diagnose_stock_sources():
        print(f"\n== {source['source']} ==")
